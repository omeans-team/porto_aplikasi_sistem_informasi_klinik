...
mysqli_query($db,"update pasien set nama_lengkap='$nama_lengkap', jenis_kelamin='$jenis_kelamin', umur='$umur', no_tlp='$no_tlp', alamat='$alamat', email='$email', uname='$uname', password='$password', level='$level' where id='$id'") or die(mysqli_error($db));
