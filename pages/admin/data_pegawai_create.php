...
<?php
	...
	$query = mysqli_query($conn, "select max(id) as kodeTerbesar from pegawai");
	$data = mysqli_fetch_array($query);
	$kodePegawai = $data['kodeTerbesar'];
...
<?php
//mendefinisikan id pegawai apakah dari tombol edit atau bukan
  ...
  if(isset($_GET['id'])){
    ...
    $id=$_GET['id'];
      ...
      //jika tidak, maka $id=$kodePegawai;
      $id=$kodePegawai;
...
<?php
  ...
  $level="pegawai";
  $avatar="avatar.jpg";
  $sql=$conn->query("select * from pegawai where id='".$id."'");
  ...
  <section class="forms">
    <div class="container-fluid">
          ...
          <header>
            ...
            <h1 class="h3 display">Data Pegawai</h1>
          </header>
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
...
//mendefinisikan id pegawai apakah dari tombol edit atau bukan
  ...
  if(isset($_GET['id'])){
    //$id=id dari tombol edit
    $id=$_GET['id'];
    ?> <form class="form-horizontal" action="data_pegawai_update.php" method="post">  <?php
  }
  else{
      //jika tidak, maka $id=$kodePegawai;
      $id=$kodePegawai;
    ?>  <form class="form-horizontal" action="data_pegawai_simpan.php" method="post"> <?php
  }
?>
